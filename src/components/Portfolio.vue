...
const meusProjetos = ref([
  ...
  },
  {
    ...
    descricao: 'Aplicação web interativa para exibição de horas em tempo real, cronômetro integrado e alternância de temas visuais (Dark/Light Mode).',
    web_base: ['HTML', 'CSS', 'JavaScript'],
    frameworks: [],
    banco_dados: [],
    back_end: [],
    ...
    <div class="projects-grid">
      ...
      >
        ...
        <div class="project-info">
          ...
          <a :href="projeto.link" class="btn-project-link">Acessar Sistema →</a>
        </div>
      </div>
    </div>
